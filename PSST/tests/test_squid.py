...
if not os.environ.has_key("CMS_PATH"):
  ...
  sys.exit(int(os.environ["ERROR_CMS_PATH_UNDEFINED"]))
#
...
if test_result == "OK" and ever_failed == "True":
  print os.environ["WARNING_SQUID_TEST_MSG"] + test_result
  #print "test_squid.py: One of the load balance Squid proxies " + test_result
  sys.exit(int(os.environ["WARNING_SQUID_TEST"]))
print "test_squid.py: All squid(s) failed"
sys.exit(int(os.environ["ERROR_FAILED_SQUID_TEST"]))
